  ...
  return (
    <div className="bg-white dark:bg-gray-900 transition-colors duration-300">
      <Layout>
        ...
        <section id="skills" className="animate-fade-in-up pt-5 bg-white dark:bg-gray-900">
        ...
        <section id="projects" className="animate-fade-in-up pt-5 mb-20 bg-white dark:bg-gray-900">
          <div className="container max-w-4xl mx-auto px-4">
            <div className="mb-16">
              <Heading text="My featured Projects" variant="rotate" withBorders={false} />
              <div className="flex justify-center">
                <div className="h-1 w-32 bg-gradient-to-r from-orange-600 to-orange-400 rounded-full"></div>
              </div>
            </div>
          <div className="Projects grid gap-8 grid-cols-1 my-5 md:grid md:grid-cols-2 lg:grid lg:grid-cols-3">

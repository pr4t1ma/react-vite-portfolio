...
`
  ...
  },
  {
    heading: "Javascript ",
    date: "2023- 2024",
    text: `"Learn to use variables, console.log, types, operators, functions, objects, arrays, JSON, DOM manipulation, and APIs. Gain confidence to build websites effectively. Gain foundational knowledge and practical skills for web development."`,
  },
  {
    heading: "React",
    date: "2024",
